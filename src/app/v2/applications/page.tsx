  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-8 space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Link href="/v2/applications/new" className="btn-primary text-sm">
          + New Application
        </Link>
      </div>
      ...
      {applications.length === 0 ? (
        <div className="card text-center py-12">
          ...
          <Link href="/v2/applications/new" className="btn-primary text-sm mt-4 inline-block">
