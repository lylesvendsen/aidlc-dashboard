  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-8 space-y-6">
      <nav className="text-sm text-gray-500">
        ...
        <Link href={`/v2/applications/${appId}`} className="hover:text-gray-900">{app.name}</Link>
        <span className="mx-2">/</span>
      ...
      <div className="flex items-start justify-between">
        ...
        <Link href={`/v2/applications/${appId}/projects/${projId}/edit`} className="btn-secondary text-sm">Edit</Link>
      </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="flex gap-2">
            <Link href={`/v2/applications/${appId}/projects/${projId}/spec-assistant`} className="btn-ghost text-sm">Spec Assistant</Link>
            <Link href={`/v2/applications/${appId}/projects/${projId}/specs/new`} className="btn-secondary text-sm">New Spec</Link>
          </div>
        </div>
