...
export default function NewSpecPage() {
  ...
  useEffect(() => {
    ...
    fetch("/api/app-specs?appId=" + appId + "&projId=" + projId)
      .then(r => r.json())
  ...
  const save = async () => {
    ...
    router.push(`/applications/${appId}/projects/${projId}`)
  }
    ...
    <div className="max-w-3xl space-y-6">
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex gap-2 shrink-0 items-center">
          ...
          <button onClick={() => router.push(`/applications/${appId}/projects/${projId}`)} className="btn-ghost">Cancel</button>
        </div>
      </div>
